...
class Policy extends \MailRoute\API\ActiveEntity
{
	public function enableSpamFiltering()
	{
		if ($this->getBypassSpamChecks()=='Y') return true;
		$this->setBypassSpamChecks('Y');
		return $this->save();
	}

	public function disableSpamFiltering()
	{
		if ($this->getBypassSpamChecks()=='N') return true;
		$this->setBypassSpamChecks('N');
		return $this->save();
	}

	public function enableVirusFiltering()
	{
		if ($this->getBypassVirusChecks()=='Y') return true;
		$this->setBypassVirusChecks('Y');
		return $this->save();
	}

	public function disableVirusFiltering()
	{
		if ($this->getBypassVirusChecks()=='N') return true;
		$this->setBypassVirusChecks('N');
		return $this->save();
	}

	public function enableBadHdrFilter()
	{
		if ($this->getBypassHeaderChecks()=='Y') return true;
		$this->setBypassHeaderChecks('Y');
		return $this->save();
	}

	public function disableBadHdrFilter()
	{
		if ($this->getBypassHeaderChecks()=='N') return true;
		$this->setBypassHeaderChecks('N');
		return $this->save();
	}

	public function enableBannedFilter()
	{
		if ($this->getBypassBannedChecks()=='Y') return true;
		$this->setBypassBannedChecks('Y');
		return $this->save();
	}

	public function disableBannedFilter()
	{
		if ($this->getBypassBannedChecks()=='N') return true;
		$this->setBypassBannedChecks('N');
		return $this->save();
	}

	public function setAntiSpamMode($mode)
	{
		if (isset($this->fields['anti_spam_preset']) && $this->fields['anti_spam_preset']==$mode)
		{
			return true;
		}
		$this->fields['anti_spam_preset'] = $mode;
		return $this->save();
	}
